...
void main()
{
    ...
    printf("Press 1 TO STRAT GAME\nPress 2 TO SEE HIGH SCORE\nPress 3 TO SEE GAME HELP\nPress 0 TO EXIT:   \n\n");
    scanf("%d",&chc);
...
void start()
{
    ...
    if((fp=fopen("\\tmp play2.txt","a"))==NULL)
        ...
        printf("******************* Welcome \" %s \"  to C Quiz Game ***************************", p.name);
        ...
        {
            printf("\nWrong answer! Correct answer is 2.Insects\n\n");
        }
        ...
        {
            printf("\nWrong answer! Correct answer is 2.Diphu, Assam\n\n");
        }
        ...
        {
            printf("\nWrong answer! Correct answer is 2.Film Finance Corporation\n\n");
        }

        printf("\nQ8. Fastest shorthand writer was \n1.Dr. G. D. Bist\t2. J.R.D. Tata\n3. J.M. Tagore\t4. Khudada Khan\n\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==1)
        {
        ...
        printf("\nQ9. Epsom (England) is the place associated with \n1.Horse racing\t2.Polo\n3.Shooting\t4.Snooker\n\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==1)
        {
        ...
        printf("\nQ10. First human heart transplant operation conducted by Dr. Christian Bernard on Louis Washkansky, was conducted in \n1.1967\t2.1968\n3.1958\t4.1922\n\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==1)
        {
        ...
        {
            printf("\nWrong answer! Correct answer is 1. 1967\n\n");
        }

        printf("\nQ11. Frames from one LAN can be transmitted to another LAN via the device \n1. Router\t2. Bridge\n3. Repeater\t4. Modem\n\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==2)
        {
        ...
        printf("\nQ12. Which of the following condition is used to transmit two packets over a medium at the same time?\n1. Contention\t2.  Collision\n3.   Synchronous\tD. Asynchronous\n\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==2)
        {
        ...
        {
            printf("\nWrong answer! Correct answer is 2. Collision\n\n");
        }

        printf("\nQ13. What are the most commonly used transmission speeds in BPS used in data communication?\n1.   300\t2. 1200\n3.   2400\t4. 9600\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==4)
        {
        ...
        {
            printf("\nWrong answer! Correct answer is 4. 9600\n\n");
        }

        printf("\nQ14.  Which of the following is used for modulation and demodulation?\n1. modem\t2. protocols\n3. gateway\t4. multiplexer\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==1)
        {
        ...
        {
            printf("\nWrong answer! Correct answer is  3. the condition when two or more stations attempt to use the same channel at the same time\n\n");
        }

        printf("\nQ16. When you ping the loopback address, a packet is sent where?\n1. On the network\n2. Down through the layers of the IP architecture and then up the layers again\n3. Across the wire\n4. through the loopback dongle\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==2)
        {
        ...
        {
            printf("\nWrong answer! Correct answer is  2. Down through the layers of the IP architecture and then up the layers again\n\n");
        }

        printf("\nQ17. Which of the following TCP/IP protocol is used for transferring electronic mail messages from one machine to another?\n1. FTP\t2.    SNMP\n3. SMTP\t4. RPC\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==3)
        {
        ...
        {
            printf("\nWrong answer! Correct answer is  3. SMTP\n\n");
        }

        printf("\nQ18. Which of the following device is used to connect two systems, especially if the systems use different protocols?\n1. hub\t2. bridge\n3. gateway\t4. repeater\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==3)
        {
        ...
        {
            printf("\nWrong answer! Correct answer is  3. gateway\n\n");
        }

        printf("\nQ19. The slowest transmission speeds are those of\n1. twisted-pair wire\t2. coaxial cable\n3. fiber-optic cable\t4.   microwaves\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==1)
        {
        ...
        printf("\nQ20. What is the port number for NNTP?\n1. 119\t2. 80\n3. 79\t4. 70\n");
        printf("Your answer: ");
        scanf("%d",&ans);
        if(ans==1)
        {
